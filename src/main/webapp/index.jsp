    ...
    <div class="login-box-body">
        ...
        <form action="/login" method="post">
            <div class="form-group has-feedback">
                <input type="user" name="username" class="form-control" placeholder="输入用户名" value="${username}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="cb" type="checkbox" ${checked}> 记住我
                            <input name="cb2" type="checkbox"> 自动登录
                        </label>
                    </div>
                </div>
                <!-- /.col -->
